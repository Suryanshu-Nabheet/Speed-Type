...
profileCmd
  ...
  .action((name: string) => manageProfile('create', name));
...
profileCmd
  ...
  .action((name: string) => manageProfile('switch', name));

profileCmd
  .command('delete <name>')
  .description('Delete a profile')
  .action((name: string) => manageProfile('delete', name));
...
raceCmd
  ...
  .action((code: string) => raceCommand('join', { code }));
